...
public class Constants {
    ...
    public final static String HOURLY_EMPLOYEE_DB = "mock_db/hourlyEmployees.txt";
    public final static String SALARY_EMPLOYEE_DB = "mock_db/salaryEmployees.txt";
    ...
    public final static String COMMISSIONED = "commissioned";
