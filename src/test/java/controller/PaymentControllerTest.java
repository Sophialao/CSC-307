...
class PaymentControllerTest {
   ...
   @Test
    public void testHourlyEmpOneTimecardPayment() {
        ...
        HourlyEmployee kelly = (HourlyEmployee) ec.addHourlyEmployee("Kelly", "SLO", 1234, 10.0, "F");
    ...
    public void testSalaryEmpPayment(){
        EmployeeController ec = new EmployeeController();
        SalaryEmployee kelly = (SalaryEmployee) ec.addSalaryEmployee("Kelly", "SLO", 1234, 100000.0, .1, 0.0, "F");
    ...
    public void testSalaryEmpCommissionPayment(){
        EmployeeController ec = new EmployeeController();
        SalaryEmployee kelly = (SalaryEmployee) ec.addSalaryEmployee("Kelly", "SLO", 1234, 100000.0, .1, 100.0, "F");
    ...
    public void testHourlyAndSalaryEmp(){
        ...
        //Salary
        SalaryEmployee kelly2 = (SalaryEmployee) ec.addSalaryEmployee("Kelly", "SLO", 1234, 100000.0, .1, 0.0, "F");
